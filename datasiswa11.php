...
<body>
  ...
  <div>
    ...
    <button><a href="datasiswaor11.php" style="text-decoration: none">INDUSTRI</a></button> 
...
<button style="margin-top: 20px;"><a style="text-decoration: none;" a target="_blank" href="export1.php">UNDUH</a></li></button>
</body>
</html>
</body>
</html>