...
<body>
  ...
  <div>
    ...
    <button><a href="datasiswa.php" style="text-decoration: none">REGULER</a></button> 
...
<button style="margin-top: 20px;"><a style="text-decoration: none;" a target="_blank" href="exportor.php">UNDUH</a></li></button>
</body>
</html>
</body>
</html>