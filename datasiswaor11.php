...
<body>
  ...
  <div>
    ...
    <button><a href="datasiswa11.php" style="text-decoration: none">REGULER</a></button> 
...
<button style="margin-top: 20px;"><a style="text-decoration: none;" a target="_blank" href="exportor1.php">UNDUH</a></li></button>
</body>
</html>
</body>
</html>